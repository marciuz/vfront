...
Come usare questo dimostrativo
	...
	Se non sai dov'� la tua cartella temporanea, prova ad usare foldertest.php
	...
	Queste impostanzioni sono necessarie perch� nel tuo localhost i files
	vengono uploadati velocemente, quindi quando scegli un file, scegline uno di grande dimensioni
	(80 Mb o pi�).

	Questo non � necessario se vuoi testare questo demo on-line, dove la velocit�
