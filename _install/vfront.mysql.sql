--
--	SQL Script MySQL VFront $Id: vfront.mysql.sql 1108 2014-10-20 20:25:04Z marciuz $
--
...
CREATE TABLE `registro_submask` (
  ...
  `nome_frontend` varchar(250) default NULL COMMENT 'Nome per la sottomaschera che apparir? nella maschera utente',
  ...
  `tipo_vista` enum('tabella','scheda','embed') NOT NULL default 'scheda',
...
--
--	Create table user, for the permission and authentication and (optional) accreditation
--
...
INSERT INTO `variabili` (`variabile`, `gid`, `valore`, `descrizione`, `tipo_var`) VALUES 
  ...
  ('use_cookies',0,'1','Use cookies for permanent login','bool')
;
